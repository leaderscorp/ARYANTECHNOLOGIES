    ...
    def _aged_partner_report_custom_engine_common(self, options, internal_type, current_groupby, next_groupby, offset=0,
        ...
        def build_result_dict(report, query_res_lines):
            ...
            if current_groupby == 'id':
                ...
                rslt.update({
                    ...
                    'invoice_origin': query_res['invoice_origin'][0] if len(query_res['invoice_origin']) == 1 else None,
        ...
        query = f"""
            ...
            SELECT
                ...
                ARRAY_AGG(DISTINCT move.invoice_origin) AS invoice_origin,
        ...
        print(len(query_res_lines))
        print(query_res_lines)
