...

{
    ...
    'author': 'BROWSEINFO',
    'website': 'https://www.browseinfo.com/demo-request?app=bi_update_qty_disable&version=19&edition=Community',
    "depends": ["stock"],
    "data": [
    ...
    "application": True,
    "auto_install": False,
    'live_test_url': 'https://www.browseinfo.com/demo-request?app=bi_update_qty_disable&version=19&edition=Community',
